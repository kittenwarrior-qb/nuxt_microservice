...
broker.loadService(path.join(__dirname, "services", "location.service.js"));
broker.loadService(path.join(__dirname, "services", "chat.service.js"));
...
broker.start()
  .then(() => {
    ...
    broker.logger.info(`API Gateway: ${protocol}://${host}:${port}`);
  })
  .catch(err => {
